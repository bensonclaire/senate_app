...
st.title(':blue[Michigan State Senate Districts]')
st.subheader(':blue[Change in Precinct Distribution between the Linden and Crane Maps]')
...
#                             color_discrete_map={'#514585':'#800000', '#800000':'#800000'},
